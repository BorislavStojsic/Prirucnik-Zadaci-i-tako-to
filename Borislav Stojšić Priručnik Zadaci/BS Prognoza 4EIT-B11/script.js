// Uzimamo URL trenutne stranice
const currentUrl = window.location.href;

// Selektujemo sve linkove u navigaciji
const navLinks = document.querySelectorAll('nav ul li a');

// Iteriramo kroz linkove i dodajemo klasu "active" ako je URL linka jednak URL-u trenutne stranice
...
function showCityInfo() {
    ...
    // Otvaranje novog prozora sa informacijama o gradu
...
// Zatvaranje modala kada korisnik klikne van njega
